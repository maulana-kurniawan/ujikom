                ...
                <form method="post" action="{{ route('anggota.store') }}">
                    ...
                    <div class="card-body">
                        <div class="form-floating mb-3">
                            <input type="text" id="nama_anggota" name="nama_anggota" class="form-control" required autofocus>
                            <label class="floating-input">Nama Anggota</label>
                        </div>
                        <div class="form-floating mb-3">
                            <select class="form-select" id="jenis_kelamin" name="jenis_kelamin" required>
                                <option selected disabled hidden value="">Pilih jenis kelamin anggota</option>
                        ...
                        <div class="form-floating mb-3">
                            <textarea id="alamat" name="alamat" class="form-control" data-bs-toggle="autosize" required></textarea>
                            <label class="floating-input">Alamat</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" id="no_hp" name="no_hp" class="form-control" data-mask="0000-0000-0000 0" data-mask-visible="true" required>
                            <label class="floating-input">No. HP</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" id="jenis_id" name="jenis_id" class="form-control" required>
                            <label class="floating-input">Jenis ID</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="number" id="no_id" name="no_id" class="form-control" required>
                            <label class="floating-input">No. ID</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" id="jenis_anggota" name="jenis_anggota" class="form-control" required>
                            <label class="floating-input">Jenis Anggota</label>
                        </div>
                        <div class="form-floating mb-3">
                            <select class="form-select" id="status" name="status" required>
                                <option selected disabled hidden value="">Pilih status anggota</option>
