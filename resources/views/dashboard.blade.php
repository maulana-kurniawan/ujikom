    ...
    <div class="container-xl">
        <div class="row row-deck row-cards">
                            ...
                            <div class="ms-auto">
                                <span class="text-green d-inline-flex align-items-center lh-1">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon ms-1" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" <path d="M3 17l6 -6l4 4l8 -8" <path d="M14 7l7 0l0 7" </svg>
                                </span>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <span class="bg-primary text-white avatar"><!-- Download SVG icon from http://tabler-icons.io/i/currency-dollar -->
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none" <path d="M16.7 8a3 3 0 0 0 -2.7 -2h-4a3 3 0 0 0 0 6h4a3 3 0 0 1 0 6h-4a3 3 0 0 1 -2.7 -2" <path d="M12 3v3m0 12v3" </svg>
                                        </span>
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <span class="bg-green text-white avatar"><!-- Download SVG icon from http://tabler-icons.io/i/shopping-cart -->
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none" <path d="M6 19m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" <path d="M17 19m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" <path d="M17 17h-11v-14h-2" <path d="M6 5l14 1l-1 7h-13" </svg>
                                        </span>
                                    </div>
                                    <div class="col">
                                        <div class="font-weight-medium">
                            ...
                            <div class="card-body card-body-scrollable card-body-scrollable-shadow">
                                <div class="divide-y">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/assets/img/static/avatars/002m.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/assets/img/static/avatars/003m.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/assets/img/static/avatars/000f.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/assets/img/static/avatars/001f.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/assets/img/static/avatars/002f.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/assets/img/static/avatars/003f.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/assets/img/static/avatars/006m.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/assets/img/static/avatars/004f.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/assets/img/static/avatars/007m.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/assets/img/static/avatars/009m.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/assets/img/static/avatars/010m.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/assets/img/static/avatars/005f.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url(/assets/img/static/avatars/006f.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div class="text-truncate">
                    ...
                    <div class="card-table table-responsive">
                        <table class="table table-vcenter">
                            ...
                            <tbody>
                                <tr>
                                    <td class="w-1">
                                        <span class="avatar avatar-sm" style="background-image: url(/assets/img/static/avatars/000m.jpg)"></span>
                                    </td>
                                ...
                                <tr>
                                    <td class="w-1">
                                        <span class="avatar avatar-sm" style="background-image: url(/assets/img/static/avatars/002m.jpg)"></span>
                                    </td>
                                    <td class="td-truncate">
                                        <div class="text-truncate">
                                ...
                                <tr>
                                    <td class="w-1">
                                        <span class="avatar avatar-sm" style="background-image: url(/assets/img/static/avatars/003m.jpg)"></span>
                                    </td>
                                    <td class="td-truncate">
                                        <div class="text-truncate">
                                ...
                                <tr>
                                    <td class="w-1">
                                        <span class="avatar avatar-sm" style="background-image: url(/assets/img/static/avatars/000f.jpg)"></span>
                                    </td>
                                    <td class="td-truncate">
                                        <div class="text-truncate">
                ...
                <div class="card card-md">
                    <div class="card-stamp card-stamp-lg">
                        <div class="card-stamp-icon bg-primary">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" <path d="M5 11a7 7 0 0 1 14 0v7a1.78 1.78 0 0 1 -3.1 1.4a1.65 1.65 0 0 0 -2.6 0a1.65 1.65 0 0 1 -2.6 0a1.65 1.65 0 0 0 -2.6 0a1.78 1.78 0 0 1 -3.1 -1.4v-7" <path d="M10 10l.01 0" <path d="M14 10l.01 0" <path d="M10 14a3.5 3.5 0 0 0 4 0" </svg>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <a href="#" class="ms-1" aria-label="Open website"><!-- Download SVG icon from http://tabler-icons.io/i/link -->
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" <path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5" <path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5" </svg>
                                    </a>
                                </td>
            ...
            <div class="col-md-6 col-lg-4">
                <a href="https://github.com/sponsors/codecalm" class="card card-sponsor" target="_blank" rel="noopener" style="background-image: url(/assets/img/static/sponsor-banner-homepage.svg)" aria-label="Sponsor Tabler!">
                        ...
                        <table class="table card-table table-vcenter">
                            <tr>
                                ...
                                <td class="text-nowrap text-muted">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" <path d="M4 5m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z" <path d="M16 3l0 4" <path d="M8 3l0 4" <path d="M4 11l16 0" <path d="M11 15l1 0" <path d="M12 15l0 3" </svg>
                                            August 04, 2021
                                </td>
                                ...
                                <td class="text-nowrap">
                                    <a href="#" class="text-muted">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" <path d="M4 21v-13a3 3 0 0 1 3 -3h10a3 3 0 0 1 3 3v6a3 3 0 0 1 -3 3h-9l-4 4" <path d="M8 9l8 0" <path d="M8 13l6 0" </svg>
                                                3</a>
                                </td>
                                <td>
                                    <span class="avatar avatar-sm" style="background-image: url(/assets/img/static/avatars/000m.jpg)"></span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="avatar avatar-sm" style="background-image: url(/assets/img/static/avatars/001f.jpg)"></span>
                                </td>
                            </tr>
                        </table>
                    </div>
