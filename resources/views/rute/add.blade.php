                ...
                <form method="post" action="{{ route('rute.store') }}">
                    ...
                    <div class="card-body">
                        <div class="form-floating mb-3">
                            <input type="text" id="tujuan" name="tujuan" class="form-control" required autofocus>
                            <label class="floating-input">Tujuan</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" id="rute_awal" name="rute_awal" class="form-control" required>
                            <label class="floating-input">Rute Awal</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" id="rute_akhir" name="rute_akhir" class="form-control" required>
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" id="id_transportasi" name="id_transportasi" class="form-control" required>
